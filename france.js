...
let cities = [
    { name: "파리", lat: 48.8566, lng: 2.3522, description: "프랑스의 수도이자 문화, 예술, 패션의 중심지로 세계적으로 유명한 명소인 에펠탑, 루브르 박물관 등이 위치해 있습니다." },
    { name: "마르세유", lat: 43.2965, lng: 5.3698, description: "프랑스 남부의 항구 도시로 역사와 문화가 풍부하며, 구시가지인 르 팡티에와 성 마리 섬 등이 관광객들에게 인기가 있습니다." },
    { name: "리옹", lat: 45.7640, lng: 4.8357, description: "프랑스 남동부에 위치한 역사와 미식의 도시로, 로마 시대의 유적과 르네상스 건물이 공존하는 특별한 도시입니다. 또한 리옹은 프랑스의 미식 중심지로 알려져 있습니다." },
    { name: "툴루즈", lat: 43.6047, lng: 1.4442, description: "프랑스 남서부에 위치한 항공 및 우주산업의 중심지로, 에어버스 본사와 유럽 우주항공 기구 (ESA)가 위치해 있습니다. 아름다운 시내와 개런 레슈갈리에가 인기 있는 명소입니다." },
    { name: "니스", lat: 43.7102, lng: 7.2620, description: "프랑스 남부의 해변 도시로 관광지로 유명하며, 나이트 라이프와 쇼핑이 활발한 몽테카를로와 프랑스 리비에라의 멋진 해변이 인기가 많습니다." },
    { name: "낭트", lat: 47.2184, lng: -1.5536, description: "프랑스 서부에 위치한 역사와 문화가 어우러진 도시로, 세계 문화유산인 낭트 성과 중세 시대의 건물들이 많이 남아있습니다. 또한 과학 박물관과 기계의 섬이 관광객들에게 인기가 있습니다." },
    { name: "스트라스부르", lat: 48.5734, lng: 7.7521, description: "프랑스 동북부에 위치한 프랑스와 독일 사이의 문화가 어우러진 도시로, 유럽 의회와 유럽 인권재판소 등 유럽 연합의 주요 기관이 위치해 있습니다. 또한 대성당과 라 페티트 프랑스 등 역사적 명소가 많이 있어 관광객들에게 인기가 많습니다." },
    { name: "보르도", lat: 44.8378, lng: -0.5792, description: "프랑스 남서부에 위치한 와인의 도시로 세계적으로 유명한 보르도 와인이 생산되는 지역입니다. 또한 보르도의 시가지는 유네스코 세계문화유산에 등재되어 있으며, 건물과 명소들이 아름답게 잘 보존되어 있습니다." },
    { name: "릴", lat: 50.6293, lng: 3.0573, description: "프랑스 북부에 위치한 릴은 프랑스와 벨기에의 교차점에 있어 유럽의 중심지로 알려져 있습니다. 오래된 건물과 현대적인 건축물이 공존하는 도시로, 광장, 박물관, 예술센터 등 다양한 명소가 있습니다." },
    { name: "몽펠리에", lat: 43.6108, lng: 3.8767, description: "프랑스 남부에 위치한 몽펠리에는 역사와 문화가 공존하는 도시로, 중세 건축물과 현대적인 시설들이 어우러져 있습니다. 또한 몽펠리에는 명문 대학들이 있어 학문과 연구의 중심지로 알려져 있습니다." }
  ];
